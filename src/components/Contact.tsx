...
const Contact = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    window.location.href = `mailto:sumanshekhar.office@gmail.com?subject=Portfolio Contact from ${form.name}&body=${form.message}`;
  };
          ...
          >
            ...
            <div className="space-y-4">
              {[
                ...
                { icon: Mail, label: "sumanshekhar.office@gmail.com", href: "mailto:sumanshekhar.office@gmail.com" },
